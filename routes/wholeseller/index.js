...
// Home route
router.get('/wholesellerDashboard', ensureAuthenticated, ensureCompanySelected, ensureTradeType, ensureFiscalYear, async (req, res) => {
    if (req.tradeType === 'Wholeseller') {
        ...
        res.render('wholeseller/index/index', {
            totalSales,
            company,
            totalPurchase,
            currentFiscalYear,
